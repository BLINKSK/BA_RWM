...
def evaluate(trained_model, backdoor):
    ...
    # model.summary()
    # model.save('four_models/vgg_16/pretrained_model.h5')
...
re_train('four_models/vgg_16/normal_model.h5')
evaluate('four_models/vgg_16/retrain_model_e20.h5', True)
evaluate('four_models/vgg_16/retrain_model_final.h5', True)
