...
def evaluate(trained_model, backdoor):
    ...
    # model.summary()
    # model.save('four_models/resnet50/pretrained_model.h5')
...
def re_train(model_path):
    BATCH_SIZE = 500
    EPOCH = 30
    saved_path = 'four_models/resnet50' 
...
re_train('four_models/resnet50/normal_model.h5')
evaluate('four_models/resnet50/retrain_model_e20.h5', True)
evaluate('four_models/resnet50/retrain_model_final.h5', True)
